...
This project was the first of two introducing networking concepts. This is an introductory project that helps learn about the OSI model, LAN and WAN networks, and TCP/UDP data transfer protocols.
